...
import type { APIProfile, APIProfileRotationStrategy, ProfilesFile, TestConnectionResult, DiscoverModelsResult } from './profile';
...
export interface ElectronAPI {
  ...
  getWorktreeFileDiff: (taskId: string, filePath: string) => Promise<IPCResult<WorktreeFileDiff>>;
  ...
  generateRoadmap: (projectId: string, enableCompetitorAnalysis?: boolean, refreshCompetitorAnalysis?: boolean, apiProfile?: string) => void;
  refreshRoadmap: (projectId: string, enableCompetitorAnalysis?: boolean, refreshCompetitorAnalysis?: boolean, apiProfile?: string) => void;
