...
export interface TaskAPI {
  ...
  getWorktreeFileDiff: (taskId: string, filePath: string) => Promise<IPCResult<import('../../shared/types').WorktreeFileDiff>>;
...
export const createTaskAPI = (): TaskAPI => ({
  ...
  getWorktreeFileDiff: (taskId: string, filePath: string): Promise<IPCResult<import('../../shared/types').WorktreeFileDiff>> =>
    ipcRenderer.invoke(IPC_CHANNELS.TASK_WORKTREE_FILE_DIFF, taskId, filePath),
